...
# abundancias de especies (Magurran, 2004). Mesmo assim, testamos o ajuste das abundancias a distribuicao log-series em todas as combinacoes correspondentes ao terceiro maior fragmento.
