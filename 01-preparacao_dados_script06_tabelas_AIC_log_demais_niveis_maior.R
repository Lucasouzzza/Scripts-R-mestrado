# No meu mestrado, foi utilizado nas análises o índice alfa de diversidade de Fisher, obtido a partir da abundância das espécies.
...
# embora o índice seja considerado robusto frente a violações desse pressuposto (Magurran, 2004).
# Ainda assim, testamos o ajuste das abundâncias à distribuição log-série em todas as combinações correspondentes ao maior fragmento.
